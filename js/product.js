const product = [
    ...
    {
        id: 2, ten: "Bánh Matcha Cuộn Kem", hinh: "3.jpg", giaban: 22000, loai: "banchay", danhmuc: "Bánh ngọt", mota: "Trà xanh thanh nhẹ, kem béo dịu.", mota_chitiet: `
    ...
    {
        id: 3, ten: "Bánh Dâu Trái Tim", hinh: "4.jpg", giaban: 25000, loai: "banchay", danhmuc: "Bánh ngọt", mota: "Socola đậm vị, kết hợp dâu tươi.", mota_chitiet: `
    ...
    {
        id: 9, ten: "Bánh Dâu Trái Tim", hinh: "4.jpg", giaban: 34000, loai: "hot", danhmuc: "Bánh đặc biệt", mota: "Socola đậm vị, kết hợp dâu tươi.", mota_chitiet: `
    Bánh Socola Dâu Trái Tim là sự kết hợp hoàn hảo giữa vị socola đậm đà và dâu tây tươi chua nhẹ. Phần cốt bánh mềm mịn, được làm từ bột cacao nguyên chất tạo nên màu sắc hấp dẫn và hương thơm đặc trưng.
    ...
    {
        id: 12, ten: "Set Bánh Giáng Sinh", hinh: "25.jpg", giaban: 40000, loai: "hot", danhmuc: "Bánh đặc biệt", mota: "Set bánh xinh xắn, dễ thương.", mota_chitiet: `
